...
public record BowPartTintSource(int slotIndex, int defaultColor) implements ItemTintSource {
  ...
  public int calculate(ItemStack itemStack, @Nullable ClientLevel clientLevel, @Nullable LivingEntity livingEntity) {
    ...
    return switch (slotIndex) {
      ...
      case 1 -> resolveColor(itemStack, clientLevel, ModDataComponents.BOW_STRING_TYPE,  ModRegistries.BOW_STRING_TYPE_KEY);
      case 2 -> resolveColor(itemStack, clientLevel, ModDataComponents.BOW_RISER_TYPE,  ModRegistries.BOW_RISER_TYPE_KEY);
      case 3 -> resolveColor(itemStack, clientLevel, ModDataComponents.BOW_REST_TYPE,   ModRegistries.BOW_REST_TYPE_KEY);
